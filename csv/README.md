...
Par défaut, Openstudio exporte 6 points par heures. Il est facile de passer a 1 point par heure
...
Une simulation produit un eso. Pour convertir un eso en csv, on utilise le ReadVarsESO.exe
```
